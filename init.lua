...
vim.keymap.set('n', 'bl', ':bn<enter>', { desc = 'Move to previous buffer' })
vim.keymap.set('n', 'bh', ':bp<enter>', { desc = 'Move to next buffer' })
vim.keymap.set('n', 'bd', ':bd<enter>', { desc = 'delete current buffer' })
